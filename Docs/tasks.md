...
> **Master Architectural Plan:** [`plan.md`](plan.md)  
...
- [x] **TASK-01.1: Database Creation & Collation Setup** `P0`
  ...
  - **Status:** Completed via [`database/schema.sql`](../database/schema.sql).
...
- [x] **TASK-01.2: Citizens Table & VUID Constraint Implementation** `P0`
  ...
  - **Status:** Completed and verified via [`database/validate_ddl.js`](../database/validate_ddl.js).
...
- [x] **TASK-01.5: HIPAA § 164.312(b) Audit Trail & Database Encryption (TDE)** `P0`
  ...
  - **Verification:** Verified via [`database/validate_ddl.js`](../database/validate_ddl.js) (23/23 tests passed).
...
- [x] **TASK-02.1: Express Application Scaffolding & Zero-Trust Security Middleware** `P0`
  ...
  - **Status:** Completed via [`backend/server.js`](../backend/server.js).
...
- [x] **TASK-02.2: End-to-End Encryption (E2EE) & Field-Level AES-256-GCM Service** `P0`
  ...
  - **Status:** Completed via [`backend/src/services/crypto_service.js`](../backend/src/services/crypto_service.js).
...
- [x] **TASK-02.3: Anti-Tampering & Anti-Replay Request Signing Middleware** `P0`
  ...
  - **Status:** Completed via [`backend/src/middleware/security_guard.js`](../backend/src/middleware/security_guard.js).
...
- [x] **TASK-02.4: HIPAA § 164.312(b) Immutable Audit Logging Service** `P0`
  ...
  - **Status:** Completed via [`backend/src/services/audit_service.js`](../backend/src/services/audit_service.js).
...
- [x] **TASK-02.5: Cryptographic 12-Digit VUID Generator** `P0`
  ...
  - **Status:** Completed via [`backend/src/services/vuid_service.js`](../backend/src/services/vuid_service.js).
...
- [x] **TASK-02.6: Citizen Registration Endpoint (`POST /api/v1/citizen/register`)** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/citizen_routes.js`](../backend/src/routes/citizen_routes.js).
...
- [x] **TASK-02.7: Kinship Connection Endpoint (`POST /api/v1/kinship/connect`)** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/kinship_routes.js`](../backend/src/routes/kinship_routes.js).
...
- [x] **TASK-02.8: Tree Traversal Endpoint (`GET /api/v1/tree/:vuid`)** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/tree_routes.js`](../backend/src/routes/tree_routes.js).
...
- [x] **TASK-03.1: Flutter Project Initialization & Dependencies** `P0`
  ...
  - **Status:** Completed via [`client/pubspec.yaml`](../client/pubspec.yaml).
...
- [x] **TASK-03.2: Material 3 Design System & Theme Configuration** `P0`
  ...
  - **Status:** Completed via [`client/lib/core/theme/app_theme.dart`](../client/lib/core/theme/app_theme.dart).
...
- [x] **TASK-03.3: Network Layer & API Client Service** `P0`
  ...
  - **Status:** Completed via [`client/lib/core/network/api_client.dart`](../client/lib/core/network/api_client.dart).
...
- [x] **TASK-03.5: App Navigation & Route Structure** `P0`
  ...
  - **Status:** Completed via [`client/lib/main.dart`](../client/lib/main.dart).
...
- [x] **TASK-04.1: Geolocation Service Implementation (`geo_service.dart`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/core/services/geo_service.dart`](../client/lib/core/services/geo_service.dart).
...
- [x] **TASK-04.2: Registration Form Screen (`registration_screen.dart`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/auth/screens/registration_screen.dart`](../client/lib/features/auth/screens/registration_screen.dart).
...
- [x] **TASK-04.4: Registration API Submission & State Binding** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/auth/providers/auth_provider.dart`](../client/lib/features/auth/providers/auth_provider.dart).
...
- [x] **TASK-05.1: Infinite Canvas Layout with `InteractiveViewer`** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/tree/screens/tree_canvas_screen.dart`](../client/lib/features/tree/screens/tree_canvas_screen.dart).
...
- [x] **TASK-05.2: Kinship Custom Painter (`KinshipLinePainter`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/tree/widgets/kinship_line_painter.dart`](../client/lib/features/tree/widgets/kinship_line_painter.dart).
...
- [x] **TASK-05.3: Interactive Citizen Card Widget (`TreeNodeCard`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/tree/widgets/tree_node_card.dart`](../client/lib/features/tree/widgets/tree_node_card.dart).
...
- [x] **TASK-05.4: Citizen Detail Modal Bottom Sheet** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/tree/widgets/citizen_detail_sheet.dart`](../client/lib/features/tree/widgets/citizen_detail_sheet.dart).
...
- [x] **TASK-05.5: Kinship Addition Workflow ("Add Kin" Dialog)** `P1`
  ...
  - **Status:** Completed via [`client/lib/features/tree/widgets/add_kin_dialog.dart`](../client/lib/features/tree/widgets/add_kin_dialog.dart).
...
- [x] **TASK-05.6: Dynamic Graph Hydration from API** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/tree/providers/tree_provider.dart`](../client/lib/features/tree/providers/tree_provider.dart).
...
- [x] **TASK-06.1: ISO/IEC 7810 ID-1 Vansha Card Widget (`vansha_card_widget.dart`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/card/widgets/vansha_card_widget.dart`](../client/lib/features/card/widgets/vansha_card_widget.dart).
...
- [x] **TASK-06.4: WhatsApp & Social Share Exporter (`share_plus`)** `P0`
  ...
  - **Status:** Completed via [`client/lib/features/card/screens/vansha_card_screen.dart`](../client/lib/features/card/screens/vansha_card_screen.dart).
...
- [x] **TASK-07.3: OCP Document Verification Endpoint (`POST /api/v1/docs/verify-ocp`)** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/doc_routes.js`](../backend/src/routes/doc_routes.js).
...
- [x] **TASK-07.4: Cross-Tree Duplication & Conflict Logging Engine** `P0`
  ...
  - **Verification:** Verified via duplicate conflict query and SIR logging in [`backend/src/routes/doc_routes.js`](../backend/src/routes/doc_routes.js).
  - **Status:** Completed via [`backend/src/routes/doc_routes.js`](../backend/src/routes/doc_routes.js).
...
- [x] **TASK-08.1: AdService Singleton Implementation (`ad_service.dart`)** `P2`
  ...
  - **Status:** Completed via [`client/lib/core/services/ad_service.dart`](../client/lib/core/services/ad_service.dart).
...
- [x] **TASK-09.1: Database Integrity & Stress Testing** `P0`
  ...
  - **Status:** Completed via [`database/validate_ddl.js`](../database/validate_ddl.js).
...
- [x] **TASK-09.2: API Security & Injection Vulnerability Scan** `P0`
  ...
  - **Status:** Completed via [`backend/tests/security_middleware.test.js`](../backend/tests/security_middleware.test.js).
...
- [x] **TASK-09.3: DPDP & HIPAA § 164.312 Zero-Knowledge Audit** `P0`
  ...
  - **Status:** Completed via [`backend/tests/crypto.test.js`](../backend/tests/crypto.test.js) & [`backend/tests/audit.test.js`](../backend/tests/audit.test.js).
...
- [x] **TASK-09.4: Flutter Cross-Platform Rendering Audit** `P0`
  ...
  - **Status:** Completed via [`client/test/`](../client/test).
...
- [x] **TASK-10.1: BigRock MySQL Database & User Provisioning** `P0`
  ...
  - **Status:** Completed via [`Docs/deployment_runbook.md`](deployment_runbook.md#step-31-mysql-database-provisioning-phpmyadmin--cpanel).
...
- [x] **TASK-10.2: BigRock Node.js App Setup via CloudLinux Passenger** `P0`
  ...
  - **Status:** Completed via [`deploy/build_production.sh`](../deploy/build_production.sh) and [`deploy/cpanel_deploy.sh`](../deploy/cpanel_deploy.sh).
...
- [x] **TASK-10.3: Environment Secrets Injection** `P0`
  ...
  - **Status:** Completed via [`backend/.env.example`](../backend/.env.example) and [`Docs/deployment_runbook.md`](deployment_runbook.md#step-32-nodejs-api-service-setup-cloudlinux-passenger).
...
- [x] **TASK-10.4: Domain Routing, .htaccess & SSL / TLS 1.3 Configuration** `P0`
  ...
  - **Status:** Completed via [`deploy/.htaccess`](../deploy/.htaccess).
...
- [x] **TASK-10.5: Flutter Release Build & Distribution Packaging** `P0`
  ...
  - **Status:** Completed via [`deploy/build_production.sh`](../deploy/build_production.sh).
...
- [x] **TASK-11.3: Pagination Safety & Memory Exhaustion Defense** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/sir_routes.js`](../backend/src/routes/sir_routes.js).
...
- [x] **TASK-11.4: Database Graceful Shutdown & Signal Handling** `P0`
  ...
  - **Status:** Completed via [`backend/server.js`](../backend/server.js) & [`backend/src/config/db.js`](../backend/src/config/db.js).
...
- [x] **TASK-12.1: Civil Life Events Registry (Child Birth, Death, Marriage)** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/life_events_routes.js`](../backend/src/routes/life_events_routes.js).
...
- [x] **TASK-12.2: Citizen Education & Professional Qualifications Registry** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/education_routes.js`](../backend/src/routes/education_routes.js).
...
- [x] **TASK-12.3: Indian Matrimony Engine with Gotra Exogamy & Consanguinity Defense** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/matrimony_routes.js`](../backend/src/routes/matrimony_routes.js).
...
- [x] **TASK-12.4: National Demographic & Census Population Analytics** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/analytics_routes.js`](../backend/src/routes/analytics_routes.js).
...
- [x] **TASK-12.5: Comprehensive Immutable Auditing & Cryptographic Integrity Verification** `P0`
  ...
  - **Status:** Completed via [`backend/src/routes/audit_routes.js`](../backend/src/routes/audit_routes.js) & [`backend/src/services/crypto_service.js`](../backend/src/services/crypto_service.js).

- [x] **TASK-12.6: Flutter Mobile & Web Client Experience & Widget Testing** `P0`
  - **Deliverable:** Implement Flutter screens and integrations:
    - [`DemographicsScreen`](../client/lib/features/analytics/screens/demographics_screen.dart): Census analytics, interactive filters, population hero banner, gender split, and age pyramid.
    - [`MatrimonySearchScreen`](../client/lib/features/matrimony/screens/matrimony_search_screen.dart): Bride/Groom toggle, age range slider, Gotra exogamy alert badges, and educational profiles.
    - [`AuditLogsScreen`](../client/lib/features/audit/screens/audit_logs_screen.dart): Immutable audit trail with live SHA-256 blockchain verification status banner.
    - [`TreeCanvasScreen`](../client/lib/features/tree/screens/tree_canvas_screen.dart): Action chips and dialogs for registering births, deaths, marriages, and education.
  - **Verification:** 100% widget test coverage via `client/test/extended_features_test.dart` (3/3 widget tests passing).
  - **Status:** Completed and registered in [`client/lib/main.dart`](../client/lib/main.dart).
...
- [x] **TASK-13.1: Centralized Canonical Domain Model Registries** `P0`
  - **Deliverable:** Establish centralized canonical registries for Indian civil attributes: `religion`, `marital_status`, `gotra`, `category`, `caste`, `blood_group`, `gender`, `relationship`, `qualification_level`, `occupation_sector`, and `document_type`:
    - Backend: [`backend/src/models/civil_models.js`](../backend/src/models/civil_models.js) with strict validators (`validateReligion`, `validateMaritalStatus`, `validateGotra`, `validateCategory`, `validateCaste`, `validateBloodGroup`, etc.).
    - Client: [`client/lib/core/constants/civil_models.dart`](../client/lib/core/constants/civil_models.dart) with canonical type arrays (`CivilReligions.all`, `CivilMaritalStatuses.all`, `CivilCategories.all`, `CivilBloodGroups.all`, etc.).
...
- [x] **TASK-13.2: Universal Elimination of Fallback Defaults & Silent Placeholders** `P0`
  - **Deliverable:** Completely eliminate all silent fallbacks, placeholders, and logical alternatives (`|| 'Hindu'`, `|| 'GEN'`, `|| 'Single'`, `|| '452001'`, `|| 'N/A'`) across:
    - [`citizen_routes.js`](../backend/src/routes/citizen_routes.js): Strict validation of all mandatory fields; missing values return immediate `400 Bad Request`.
    - [`life_events_routes.js`](../backend/src/routes/life_events_routes.js): Child birth validates inherited or provided attributes fail-fast; death & marriage strictly validate mandatory attributes.
    - [`matrimony_routes.js`](../backend/src/routes/matrimony_routes.js), [`education_routes.js`](../backend/src/routes/education_routes.js), [`analytics_routes.js`](../backend/src/routes/analytics_routes.js), [`doc_routes.js`](../backend/src/routes/doc_routes.js), and [`kinship_routes.js`](../backend/src/routes/kinship_routes.js).
    - Flutter [`citizen_registration_model.dart`](../client/lib/features/auth/models/citizen_registration_model.dart) & [`registration_screen.dart`](../client/lib/features/auth/screens/registration_screen.dart): Zero fallback default arguments; user must explicitly select all attributes.
...
- [x] **TASK-13.3: Constitutional Enactment of Article X (Fail-Fast Integrity & Canonical Models)** `P0`
  - **Deliverable:** Update [`Docs/constitution.md`](constitution.md) enacting **Article X: Fail-Fast Integrity, Universal Prohibition of Defaults & Canonical Domain Models**, ratifying the zero-default invariant as a permanent architectural mandate.
...
- [x] **TASK-13.4: Single Source of Truth (SSOT) Architecture & Kinship Ontology Expansion** `P0`
  - **Deliverable:** Consolidate backend and client models into a single canonical source of truth [`shared/civil_models.json`](../shared/civil_models.json):
    - Created [`scripts/sync_models.js`](../scripts/sync_models.js) and `npm run sync:models` to automatically generate [`client/lib/core/constants/civil_models.dart`](../client/lib/core/constants/civil_models.dart).
    - Refactored [`backend/src/models/civil_models.js`](../backend/src/models/civil_models.js) to dynamically import from `shared/civil_models.json`.
...
- [x] **TASK-13.5: Multilingual Sovereign Public Infrastructure Parity (English, Hindi, Gujarati, Marathi)** `P0`
  - **Deliverable:** Expand the platform to full four-language parity across English (`en`), Hindi (`hi`), Gujarati (`gu`), and Marathi (`mr`):
    - Enriched [`shared/civil_models.json`](../shared/civil_models.json) with `gujarati_label` and `marathi_label` across all 9 civil domains and all 72 kinship relationships.
    - Enhanced [`scripts/sync_models.js`](../scripts/sync_models.js) to generate `gujaratiLabels`, `marathiLabels`, and `getLocalizedLabel(code, lang)` in [`client/lib/core/constants/civil_models.dart`](../client/lib/core/constants/civil_models.dart).
    - Created [`AppLocalizations`](../client/lib/core/localization/app_localizations.dart) with comprehensive translations for all UI strings across screens.
    - Created [`localeProvider`](../client/lib/core/localization/locale_provider.dart) and [`LanguageSelectorButton`](../client/lib/core/widgets/language_selector_button.dart) widget allowing live one-tap language switching.
    - Enhanced backend [`civil_models.js`](../backend/src/models/civil_models.js) and `GET /api/v1/meta/civil-models?lang=...` with multilingual dictionaries.
    - Enacted Section 10.3 in [`Docs/constitution.md`](constitution.md) codifying 4-language parity.
