...
[![Tests](https://img.shields.io/badge/Flutter%20Tests-24%2F24%20Passed-brightgreen)](test)
...
4. **Canonical Civil Models & Zero-Default Policy**: All dropdowns and domain fields are strictly validated against [`client/lib/core/constants/civil_models.dart`](lib/core/constants/civil_models.dart). Form fields require explicit user selection without silent fallback defaults, enforcing [Constitution Article X](../Docs/constitution.md#article-x-fail-fast-integrity-universal-prohibition-of-defaults--canonical-domain-models).

---

## 2. Feature & Screen Directory

### 2.1 Interactive Lineage Canvas ([`tree_canvas_screen.dart`](lib/features/tree/screens/tree_canvas_screen.dart))
...
- One-tap action chips for civil lifecycle events:
  - **Add Kin Dialog** ([`add_kin_dialog.dart`](lib/features/tree/widgets/add_kin_dialog.dart))
...
### 2.2 Vansha Card Credential & WhatsApp Sharing ([`vansha_card_widget.dart`](lib/features/card/widgets/vansha_card_widget.dart))
...
### 2.3 Indian Matrimony Engine & Gotra Exogamy ([`matrimony_search_screen.dart`](lib/features/matrimony/screens/matrimony_search_screen.dart))
...
### 2.4 Demographic & Census Analytics Dashboard ([`demographics_screen.dart`](lib/features/analytics/screens/demographics_screen.dart))
...
### 2.5 Immutable Audit Logs Inspector ([`audit_logs_screen.dart`](lib/features/audit/screens/audit_logs_screen.dart))
...
### 2.6 Citizen Registration with Live GPS Autofill ([`registration_screen.dart`](lib/features/auth/screens/registration_screen.dart))
...
Located in [`client/lib/core/constants/civil_models.dart`](lib/core/constants/civil_models.dart):
